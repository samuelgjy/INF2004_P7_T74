...
void move_backward(){
    ...
    pwm_set_chan_level(slice_num01, PWM_CHAN_A, 12500/1.4 - dc_adjust_right);
    pwm_set_chan_level(slice_num02, PWM_CHAN_B, 12500/1.4 - dc_adjust_left);
    gpio_put(motorDirR01, 0);
...
void move_turn_right(){
    ...
    pwm_set_chan_level(slice_num01, PWM_CHAN_A, 2500);
    pwm_set_chan_level(slice_num02, PWM_CHAN_B, 12500/1.45 - dc_adjust_left);
    gpio_put(motorDirR01, 1);
    gpio_put(motorDirR02, 0);
    gpio_put(motorDirL01, 1);
    gpio_put(motorDirL02, 0);
...
void move_turn_left(){
    ...
    pwm_set_chan_level(slice_num01, PWM_CHAN_A, 12500/1.45 - dc_adjust_right);
    pwm_set_chan_level(slice_num02, PWM_CHAN_B, 2500);
    gpio_put(motorDirR01, 1);
    gpio_put(motorDirR02, 0);
    gpio_put(motorDirL01, 1);
    gpio_put(motorDirL02, 0);
